...
// ------------------------------------------------------------
// Cada staff tiene correo + clave para el login del Dashboard (demo).
// El rol define qué ve: Administrador = todo · Entrenador = Horarios + ingreso.
const STAFF_DEMO = [
    { id: 'st4', auth_user_id: null, nombre: 'Carlos Abarca Fuentes', rol: 'Administrador', correo: 'carlos.abarca@gimnasiodemo.cl', clave: 'Carlos.Admin2026', permisos: ['clientes', 'finanzas', 'staff', 'tv'], creado_en: _ts(_meses(-1, 1)) },
    { id: 'st1', auth_user_id: null, nombre: 'Javier (Dueño)', rol: 'Administrador', correo: 'javier@gimnasiodemo.cl', clave: 'Admin.2026',   permisos: ['clientes', 'finanzas', 'staff', 'tv'], creado_en: _ts(_meses(-8, 1)) },
    { id: 'st2', auth_user_id: null, nombre: 'Paula Guzmán',   rol: 'Entrenadora',   correo: 'paula@gimnasiodemo.cl',  clave: 'Entrena.2026', permisos: ['clientes', 'tv'],                     creado_en: _ts(_meses(-5, 1)) },
    { id: 'st3', auth_user_id: null, nombre: 'Nicolás Rivas',  rol: 'Entrenador',    correo: 'nicolas@gimnasiodemo.cl', clave: 'Entrena.2026', permisos: ['clientes'],                           creado_en: _ts(_meses(-2, 1)) }
];
...
const CLIENTES_DEMO = [
    ...
    // 19) Carlos Abarca Fuentes — perfil de socio del cliente (dueño). Cuenta lista para el portal.
    _cli({
        id: 'c19', nombre: 'Carlos', apellido: 'Abarca Fuentes', correo: 'carlosabarca.fit@gmail.com',
        telefono: '+56 9 7777 8888', telefonoEmergencia: '+56 9 6000 9999', emergencia1Nombre: 'Familiar Abarca',
        genero: 'M', cumpleanos: _fecha(1988, 4, 12), planId: '5d_12m', racha_meses: 3,
        vence: _meses(9, 12), fechaIngreso: _meses(-1, 12), estado: 'Al día',
        asistioHoy: false, asistenciasMes: 6, saludControlesAlDia: true, saludGrupo: 'O+',
        contratoNombre: 'Carlos Abarca Fuentes',
        pagos: [
            _pago('c19', 1, _meses(-1, 12), 'Plan 5 Días (12m)', 240000, 'Transferencia')
        ],
        medidasHistorial: [
            _med('c19', 1, _meses(-1, 12), { peso: 80, cintura: 86, pierna_izq: 57, pierna_der: 57 })
        ],
        prsHistorial: [
            _pr('c19', 1, 'Press Banca', 80, _meses(0, 5))
        ]
    })
];
